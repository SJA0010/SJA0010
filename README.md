...
# Flutter Developer | UI Expert | Android App Developer
...
<p align="left"> 
I'm <strong>Subhan Abbasi</strong>, a professional <strong>Flutter full stack developer</strong> and expert in Front
end (web and apps). I have done <strong>15+ Flutter projects</strong>. I have mastered the skills of hybrid
application (iOS and Android) with 2 years of experience as an intern at 7-Skies Solution. During my
journey in Software Engineering, I have gained significant experience, including leadership skills, and
learned to differentiate code standards. With 2 years of experience, I can read your ideas and
create a masterpiece out of them. My first priority is your satisfaction.
  
I have knowledge of Firebase, and I am an expert in API Integration. I am the creator of <strong>GetX</strong>, a mobile/frontend framework capable of accelerating mobile, web, and desktop development, which uses Flutter as a base, and <strong>GetServer</strong>, a backend framework based on the same syntax, as well as authoring some multiplatform native solutions for Flutter, like <strong>VideoCompress</strong>. I'm passionate about <strong>productivity hacks</strong>, and I strive to make other developers' lives more productive.

For the last few years, I have worked in consultancy: <strong>legal</strong>, generally related to privacy policies, terms of use, data protection laws, or <strong>technical</strong> related to backend/frontend projects, related to structure, organization security. I'm currently an intern at 7-Skies Solution.
...
<div align="center">
  <div style="text-align: center; display: inline-block; margin: 20px; width: 45%;">
    <div style="border: 1px solid #ccc; border-radius: 5px; padding: 10px;">
      ...
      <a href="https://github.com/SJA0010/petcare" target="_blank" rel="noopener noreferrer">
        <img src="https://github.com/SJA0010/SJA0010/blob/main/Copy%20of%20web%20app%20ui%20(1).jpg" width="100%" style="border-radius: 5px;">
      </a>
      <div style="text-align: left; margin-top: 10px;">
        Pet-care app was commercial app for vet doctors and patients for scheduling a appointment and keeping history of old pets. I put an magnifying efforts to make it look attract and Alhumdullia our client was satisfied and happy to see out efforts...... 🐾 Excited to share a sneak peek of my latest pet care UI design project! 🐶🐱 I've poured my passion for pets into creating a seamless and visually appealing experience for pet owners. From interactive dashboards to user-friendly interfaces, every detail is designed to make caring for our furry friends a joy. Swipe through to see the love and effort that went into this project! 🐾✨
      </div>
    </div>
  </div>
